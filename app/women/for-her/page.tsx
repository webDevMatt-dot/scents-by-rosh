...
export default function ForHerPage() {
  const items = products.filter((p) => p.category === "for-her");

  return (
    // Added full-width wrapper with 'bg-black' and 'min-h-screen'
    <div className="min-h-screen bg-black text-white">
      <div className="px-6 py-16 max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <p className="text-amber-400 text-sm tracking-[0.3em] uppercase">COLLECTION</p>
          <h1 className="text-5xl md:text-6xl font-serif text-white mt-4">FOR HER</h1>
